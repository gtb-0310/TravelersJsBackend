...
const messages = {
    en: {
        ...
        AUTH_USER_NOT_FOUND: "User not found, please check the email address.",
        ...
        FAILD_FETCH_REASONS_REPORTING: "An error occured while the reporting reasons recuperation.",
        REASON_REPORTING_NOT_FOUND: "Reason reporting not found.",
        INVALID_REASON_ID: "Reason Id not valid.",
        REPORT_NOT_FOUND: "Reporting not found.",
        USER_BANNED_ONE_DAY_SUCCESSFULLY: "User banned for one day successfully!",
    ...
    fr: {
        ...
        AUTH_USER_NOT_FOUND: "L'utilisateur n'a pas été trouvé, vérifiez l'adresse mail.",
        ...
        FAILD_FETCH_REASONS_REPORTING: "Une erreur s'est produite durant la récupération des raisons de signalement.",
        REASON_REPORTING_NOT_FOUND: "Raison de signalement non trouvée.",
        INVALID_REASON_ID: "ID de la raison invalide.",
        REPORT_NOT_FOUND: "Signalement non trouvé.",
        USER_NOT_FOUND: "Utilisateur non trouvé.",
        USER_BANNED_SUCCESSFULLY: "Utilisateur suspendu avec succès!",
        USER_BANNED_ONE_DAY_SUCCESSFULLY: "utilisateur suspendu un jour!",
